...
> [!pf2-note] This version of [[Poison Resistance ]] is intended for use with the Poisoner Archetype. Its level has been changed accordingly.
...
collapse: closed
# Poisoner's Twist  *⬻{ .Pathfinder }* *Feat 4*  
[[Archetype]]  
...
> [!pf2-note] This version of [[Subtle Delivery]] is intended for use with the Poisoner Archetype. Its level has been changed accordingly.
...
> [!pf2-note] This version of [[Poison Weapon]] is intended for use with the Poisoner Archetype. Its level has been changed accordingly.
...
> [!pf2-note] This version of [[Tenacious Toxins]] is intended for use with the Poisoner Archetype. Its level has been changed accordingly.
...
collapse: closed
# Acquired Tolerance  *⬲{ .Pathfinder }* *Feat 8*  
[[Archetype]]  [[fortune]]  
...
> [!pf2-note] This version of [[Sticky Poison]] is intended for use with the Poisoner Archetype. Its level has been changed accordingly.


A combination of additional viscosity and careful application keeps your weapons poisoned even when suffering significant wear and tear. If your [[Strike]] with a poisoned weapon would expend its poison without your target attempting an initial save  being a critical failure, for example), attempt a DC 5 flat check. On a success, your weapon remains poisoned. If your [[Strike]] with a poisoned weapon succeeds, attempt a DC 17 flat check. On a success, your weapon remains poisoned until the end of your next turn.
...
> [!pf2-note] This version of [[Improved Poison Weapon]] is intended for use with the Poisoner Archetype. Its level has been changed accordingly.
...
> [!pf2-note] This version of [[Pinpoint Poisoner]] is intended for use with the Poisoner Archetype. Its level has been changed accordingly.
...
collapse: closed
# Chemical Contagion  *⬲{ .Pathfinder }* *Feat 18*  
[[alchemist]]  

> [!pf2-note] This version of [[Chemical Contagion]] is intended for use with the Poisoner Archetype. Its level has been changed accordingly.
