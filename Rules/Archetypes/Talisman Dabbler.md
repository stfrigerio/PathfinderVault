...
Finally, when you [[Affix a Talisman]], you can  affix or remove up to four talismans in the 10-minute span.
...
You can attach a talisman using only a bit of glue and some string. You gain the [[Rapid Affixture]] skill feat, even if you don't meet the prerequisites.
...
> [!pf2-note] This version of [[Talismanic Sage]] is intended for use with the Talisman Dabbler Archetype. Its level has been changed accordingly.
