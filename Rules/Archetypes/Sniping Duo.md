...
collapse: closed
# Assisting Shot  *⬻{ .Pathfinder }* *Feat 4*  
[[fighter]]  [[press]]  

> [!pf2-note] This version of [[Assisting Shot]] is intended for use with the Sniping Duo Archetype. Its level has been changed accordingly.
...
collapse: closed
# Cover Fire  *⬻{ .Pathfinder }* *Feat 4*  
[[gunslinger]]  

> [!pf2-note] This version of [[Cover Fire]] is intended for use with the Sniping Duo Archetype. Its level has been changed accordingly.
...
The penalty you take for firing into further range increments is –3 for the third range increment, with an additional –2 penalty for each additional increment beyond the third .
...
collapse: closed
# Exploit Opening  *⬲{ .Pathfinder }* *Feat 6*  
[[Archetype]]  
...
You take advantage of your spotter's devastating attack to unleash your own follow-up attack. Make a ranged [[Strike]] with a –2 penalty against the target of the triggering attack.

This [[Strike]] doesn't count toward your multiple attack penalty and your multiple attack penalty doesn't apply to the [[Strike]].
...
collapse: closed
# Targeted Redirection  *⬻{ .Pathfinder }* *Feat 6*  
[[Archetype]]  
...
If your next action is to make a ranged [[Strike]], you treat your spotter's position as your own for the purposes of determining cover and range. Your spotter must be within your weapon's first range increment and they must use a reaction to redirect your shot.
...
You and your spotter take advantage of each other's attacks to momentarily hide and throw your foes off-balance against your follow-up attack. When you successfully make a ranged [[Strike]] against a foe, your spotter can use a reaction to attempt a [[Stealth]] check against the foe's [[Perception]] DC.

On a success, the foe is [[flat-footed]] against the spotter's next attack before the end of your spotter's next turn. Similarly, when your spotter successfully makes a ranged [[Strike]] against a foe, you can use a reaction to attempt a [[Stealth]] check against the foe's [[Perception]] DC. On a success, the foe is [[flat-footed]] against your next attack against them before the end of your next turn.
...
collapse: closed
# Deflecting Shot  *⬲{ .Pathfinder }* *Feat 12*  
[[gunslinger]]  

> [!pf2-note] This version of [[Deflecting Shot]] is intended for use with the Sniping Duo Archetype. Its level has been changed accordingly.
...
> [!pf2-note] This version of [[Eagle Eyes]] is intended for use with the Sniping Duo Archetype. Its level has been changed accordingly.
...
collapse: closed
# Redirecting Shot  *⬲{ .Pathfinder }* *Feat 12*  
[[fortune]]  [[gunslinger]]  

> [!pf2-note] This version of [[Redirecting Shot]] is intended for use with the Sniping Duo Archetype. Its level has been changed accordingly.
...
> [!pf2-note] This version of [[Concentrated Assault]] is intended for use with the Sniping Duo Archetype. Its level has been changed accordingly.
