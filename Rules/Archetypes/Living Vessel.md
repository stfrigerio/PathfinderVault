...
With the dawning of a new era comes the need for a new seat of power, and what better way to show your coming master your devotion than by sacrificing your entire being for their use? You presented yourself before their altar and they answered your call, flooding your body with their power and granting you the gift of their original form. Or maybe you were abducted in the dark, on a night that the moon refused to shine, when you were taken to a profane location where a mysterious cult bound you to their master against your will. Now you have powers you didn't before and you have new features that scare  you.
...
```ad-embed-ability
title: Entity's Resurgence *⬲{ .Pathfinder }*

- **Trigger**: You would be reduced to 0 Hit Points but not immediately killed

**Effect** Instead of letting you fall [[unconscious]], your entity takes control.
...
collapse: closed
# Tap Vitality  *⬻{ .Pathfinder }* *Feat 6*  
...
collapse: closed
# Exude Abyssal Corruption  *⬻{ .Pathfinder }* *Feat 8*  
...
collapse: closed
# Fey's Trickery  *⬺{ .Pathfinder }* *Feat 8*  
...
collapse: closed
# Warped Constriction  *⬻{ .Pathfinder }* *Feat 8*  
[[Archetype]]  
...
collapse: closed
# Vessel's Form  *⬺{ .Pathfinder }* *Feat 16*  
[[Archetype]]  [[concentrate]]  [[polymorph]]  [[transmutation]]  

> [!pf2-note] This version of [[Vessel's Form]] is intended for use with the Living Vessel Archetype. Its level has been changed accordingly.
