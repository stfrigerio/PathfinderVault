...
```ad-embed-ability
title: Slayer's Identification *⭓{ .Pathfinder }*

- **Trigger**: You roll initiative and can observe a creature you know is undead

**Effect** You attempt to [[Recall Knowledge]] to identify the undead creature with a +1 circumstance bonus. If you're a master in the skill you're using to [[Recall Knowledge]], you gain a +2 circumstance bonus instead.
```
...
- **Trigger** You fail a check to [[Treat a Disease]] that was inflicted by an undead  or mummy rot).
...
collapse: closed
# Slayer's Strike  *⬺{ .Pathfinder }* *Feat 4*  
...
collapse: closed
# Frighten Undead  *⬻{ .Pathfinder }* *Feat 6*  
[[Archetype]]  
