...
collapse: closed
# Firebrand Braggart Dedication  *⬻{ .Pathfinder }* *Feat 4*  
[[Archetype]]  [[dedication]]  [[misfortune]]  [[uncommon]]  
...
collapse: closed
# Boaster's Challenge  *⬻{ .Pathfinder }* *Feat 6*  
[[Archetype]]  [[mental]]  
...
collapse: closed
# Bravo's Determination  *⬲{ .Pathfinder }* *Feat 8*  
[[Archetype]]  
...
If your skill check to challenge a foe is a success, the target of your challenge takes a–1 circumstance penalty to attack rolls  until the end of your next turn.
...
> [!pf2-note] This version of [[Daredevil's Gambit]] is intended for use with the Firebrand Braggart Archetype. Its level has been changed accordingly.
