...
Your sterling dynamo prosthesis is especially optimized for combat, granting you a dynamo melee unarmed attack that is in the brawling weapon group and is made of silver 
...
Your dynamo has modular configurations, allowing you to swap between various different possibilities with ease in order to adapt to various situations in combat. Your dynamo attack gains the [[modular]] trait , as well as one of the following configurations of your choice: power driver , percussive striker , rotating sickle , or entangling barbs . If you have a manually controlled dynamo, these damage dice increase by 1 size, as usual, and you can also choose the extendable baton , which has the damage increase already factored in.
...
collapse: closed
# Piston Punch  *⬺{ .Pathfinder }* *Feat 6*  
[[Archetype]]  
...
collapse: closed
# Stasian Smash  *⬺{ .Pathfinder }* *Feat 8*  
[[Archetype]]  [[uncommon]]  
...
collapse: closed
# Beast Dynamo Howl  *⬺{ .Pathfinder }* *Feat 10*  
[[Archetype]]  [[uncommon]]  
...
> [!pf2-note] This version of [[Golem Dynamo]] is intended for use with the Sterling Dynamo Archetype. Its level has been changed accordingly.
...
> [!pf2-note] This version of [[Soaring Dynamo]] is intended for use with the Sterling Dynamo Archetype. Its level has been changed accordingly.
