...
```ad-embed-feat
title: Quick Draw , Feat 4*
collapse: closed
# Quick Draw   *⬻{ .Pathfinder }* *Feat 4*  
[[rogue]]  

> [!pf2-note] This version of [[Quick Draw ]] is intended for use with the Vigilante Archetype. Its level has been changed accordingly.
...
collapse: closed
# Startling Appearance  *⬻{ .Pathfinder }* *Feat 6*  
...
Make a [[Strike]] against your target. That creature is [[flat-footed]] against this [[Strike]], as normal. If your [[Strike]] hits, the target remains [[flat-footed]] for the rest of your turn and is [[frightened]]  on a critical hit).
...
> [!pf2-note] This version of [[Frightening Appearance]] is intended for use with the Vigilante Archetype. Its level has been changed accordingly.
...
> [!pf2-note] This version of [[Stunning Appearance]] is intended for use with the Vigilante Archetype. Its level has been changed accordingly.

- **Prerequisites**: [[Startling Appearance]]

Your sudden appearance leaves your foe unable to respond.

When you use Startling Appearance, if your foe's level is equal to or lower than yours, they are also [[stunned]] on a hit, or [[stunned]] on a critical hit.
