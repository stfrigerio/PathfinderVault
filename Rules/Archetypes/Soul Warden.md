...
When you have at least two other feats from this archetype, the spiral glows with bright light in a 10-foot radius . Feats that require a creature or object to be in the light of your spiral function whether it's in the bright or dim light.
...
> [!pf2-note] This version of [[Domain Initiate]] is intended for use with the Soul Warden Archetype. Its level has been changed accordingly.
...
collapse: closed
# Liberate Soul  *⬺{ .Pathfinder }* *Feat 6*  
...
collapse: closed
# Spiral Sworn  *⬻{ .Pathfinder }* *Feat 6*  
...
> [!pf2-note] This version of [[Expanded Domain Initiate]] is intended for use with the Soul Warden Archetype. Its level has been changed accordingly.
...
> [!pf2-note] This version of [[Advanced Domain]] is intended for use with the Soul Warden Archetype. Its level has been changed accordingly.
