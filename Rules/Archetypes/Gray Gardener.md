...
collapse: closed
# Harsh Judgment  *⬻{ .Pathfinder }* *Feat 4*  
[[Archetype]]  [[vigilante]]  
...
Your voice be heard easily by any creatures within 300 feet if you wish, regardless of the level of ambient noise, although your voice can't penetrate silence or similar effect. If you roll [[Intimidation]] for initiative, on the first round of combat, creatures that haven't acted yet are [[flat-footed]] to you.
...
If you use [[Sense Motive]] on a creature you have currently condemned with Harsh Judgment, your GM rolls the [[Perception]] check twice and takes the higher result  effect).
...
collapse: closed
# Frightful Condemnation  *⭓{ .Pathfinder }* *Feat 6*  
...
Your condemned foe is [[frightened]], or [[frightened]] if the triggering [[Strike]] was a critical hit.
...
collapse: closed
# Gardener's Resolve  *⬲{ .Pathfinder }* *Feat 8*  
[[Archetype]]  [[vigilante]]  

- **Prerequisites**: [[Vigilante Dedication]], member of the Gray Gardeners
- **Frequency**: once per day
- **Trigger** You roll a failure  on a Will save against a [[fear]] effect.
- **Activity** Reaction
...
collapse: closed
# Reminder of the Greater Fear  *⬲{ .Pathfinder }* *Feat 8*  
[[Archetype]]  [[vigilante]]  
...
collapse: closed
# Execution  *⬺{ .Pathfinder }* *Feat 14*  
[[Archetype]]  [[vigilante]]  

> [!pf2-note] This version of [[Execution]] is intended for use with the Gray Gardener Archetype. Its level has been changed accordingly.
...
collapse: closed
# Terrifying Countenance  *⭓{ .Pathfinder }* *Feat 18*  
[[Archetype]]  [[vigilante]]  

> [!pf2-note] This version of [[Terrifying Countenance]] is intended for use with the Gray Gardener Archetype. Its level has been changed accordingly.
