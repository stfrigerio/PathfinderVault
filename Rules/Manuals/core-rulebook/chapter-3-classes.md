...
In your companion's natural environment, it can use a [Sneak](../actions/sneak.md) action even if it's currently observed. Its proficiency rank in [Stealth](Skills.md#Stealth) increases to expert (or master if it was already an expert from its type), and its Dexterity modifier increases by 1. Its proficiency rank for unarmored defense increases to expert.
